											...
											<div class="ibox-title text-center"></div>
												<div class="ibox-content">
														...
														<div class="form-group">
															<div class="row">
																<div class="col-md-4">
																	<div class="col-md-6"><label>Loan Applied Amount</label></div>
																	<div class="col-md-6">
																	<input readonly name="loan_amt" id="loan_amt" class="form-control" value="{{$values->LoanAppAmt}}">
																	</div>
																</div>
																{{-- <div class="col-md-4">
																	<div class="col-md-6"><label>Disburse Amount</label></div>
																	<div class="col-md-6"><input readonly name="disburse_amt" class="form-control" value="{{$values2->DisburseAmt}}"></div>
																</div> --}}
																<div class="col-md-4">
														...
														<div class="form-group">
															<div class="row">
																<div class="col-md-5">
																	<div class="col-md-3"><label>Application Date</label></div>
																	<div class="col-md-9">
																	<input readonly class="form-control" id="data_1" name="DTOS" required value="{{$values->AppDate}}">
																	</div>
																</div>
																{{-- <div class="col-md-3">
																	<div class="col-md-3"><label>Start Date</label></div>
																	<div class="col-md-9"><input type="date" name="start_date" id="start_date" class="form-control" required></div>
																</div> --}}
																<div class="col-md-5">
																	<div class="col-md-3"><label>Installment Size</label></div>
																	<div class="col-md-9"><input readonly name="MonthlyEMI" id="MonthlyEMI" class="form-control"></div>
																</div>
																{{-- <div class="col-md-2">
														...
														<div class="form-group">
															<div class="row">
																<div class="col-md-4">
																	<div class="col-md-6"><label>Insurance Fees</label></div>
																	<div class="col-md-6"><input type="text" name="insurance_fees" class="form-control"></div>
																</div>
																<div class="col-md-4">
																	<div class="col-md-6"><label>Membership Fees</label></div>
														...
														<div class="form-group">
																...
																<div class="col-md-6">
																		...
																		<div class="row">
																			...
																			<div class="col-md-3"><input type="text" name="process_fee" class="form-control"></div>
																			<div class="col-md-1">%</div>
																			<div class="col-md-3"><input type="text" name="" class="form-control" ></div>
																		</div><br>
																		<div class="row">
																			<div class="col-md-3"><label>Document Fee </label></div>
																			<div class="col-md-3"><input type="text" name="doc_fee" class="form-control"></div>
																			<div class="col-md-1">%</div>
																			<div class="col-md-3"><input type="text" name="" class="form-control" ></div>
																		</div>
																	<!-- </div> -->
																...
																<div class="col-md-6">
																	...
																	<div class="row">
																		<div class="col-md-6">
																			<label>Bank&nbsp;&nbsp;</label><input type="text" name="bank_name" class="form-control">
																		</div>
																	</div>
																</div>
